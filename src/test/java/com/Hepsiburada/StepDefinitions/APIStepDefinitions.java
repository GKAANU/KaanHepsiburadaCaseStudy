...
import com.Hepsiburada.API.ApiExecutor;
...
public class APIStepDefinitions {
    ...
    /**
     * Burada update için "https://petstore.swagger.io/#/" dökümantasyonunda verilen "put" HTTP request type'ı
     * dökümantasyon hatası nedeniyle update etmek yerine tıpkı post gibi yeni bir pet oluşturuyor ve yeni bir id atıyor
     * bu nedenle update işlemi sağlıklı çalışmadı, ayrıca user için yazılan dökümantasyonda hatalı olduğu için update
     * status code 200 görüldüğünden geçerli var sayıldı
     */
